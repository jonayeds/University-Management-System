...
const getASingleAcademicDepartment = catchAsync(async(req:Request, res:Response)=>{
    const {academicDepartmentId} = req.params
    const result =await AcademicDepartmentServices.getASingleAcademicDepartment(academicDepartmentId)
    response(res, {
        success:true,
        message:"Successfully added Academic Department",
        data:result,
...
const updateAcademicDepartment = catchAsync(async(req:Request, res:Response)=>{
    const {academicDepartmentId} = req.params
    const result =await AcademicDepartmentServices.updateAcademicDepartment(academicDepartmentId, req.body)
    response(res, {
        success:true,
