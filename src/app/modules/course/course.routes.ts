...
router.post("/create-course",auth(User_role.admin), requestValidator(CourseValidations.createCourseValidationSchema), CourseControllers.createCourse)
router.get("/",auth(User_role.admin, User_role.faculty, User_role.student), CourseControllers.getAllCourses)
router.get("/:id",auth(User_role.admin, User_role.faculty, User_role.student), CourseControllers.getASingleCourse)
router.patch("/:id",auth(User_role.admin), requestValidator(CourseValidations.updateCourseValidationSchema), CourseControllers.updateCourse)
