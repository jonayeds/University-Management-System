...
StudentRoutes.get('/',auth(User_role.admin, User_role.faculty), studentControllers.getAllStudents);
StudentRoutes.get('/:studentId',auth(User_role.admin, User_role.faculty), studentControllers.getASingleStudent);
