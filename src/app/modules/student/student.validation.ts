...
const userNameValidationSchema = z.object({
  firstName: z
    ...
    .regex(/^[A-Z][a-z]+$/, {
      message:
        'First name must start with an uppercase letter and the rest lowercase.',
    }),
...
const guardianValidationSchema = z.object({
  ...
  fatherContactNo: z
    ...
    .trim()
    .regex(/^\d{10}$/, {
      message: 'Father contact number must be a 10-digit number.',
    })
    .optional(),
  ...
  motherContactNo: z
    ...
    .trim()
    .regex(/^\d{10}$/, {
      message: 'Mother contact number must be a 10-digit number.',
    })
    .optional(),
...
const localGuardianValidationSchema = z.object({
  ...
  contactNo: z
    ...
    .trim()
    .regex(/^\d{10}$/, {
      message: 'Local guardian contact number must be a 10-digit number.',
    })
    .optional(),
});
